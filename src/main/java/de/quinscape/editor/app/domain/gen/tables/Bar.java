 ...
 */
package de.quinscape.editor.app.domain.gen.tables;


import de.quinscape.editor.app.domain.gen.Keys;
import de.quinscape.editor.app.domain.gen.Public;
...
public class Bar extends TableImpl<BarRecord> {
	...
	private static final long serialVersionUID = 1523947500;
	 ...
	 */
	public final TableField<BarRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(150).nullable(false), this, "");

	/**
	 * The column <code>public.bar.num</code>.
	 */
	public final TableField<BarRecord, Integer> NUM = createField("num", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
	...
	public List<UniqueKey<BarRecord>> getKeys() {
		return Arrays.<UniqueKey<BarRecord>>asList(Keys.BAR_PKEY);
	}
	...
	public List<ForeignKey<BarRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<BarRecord, ?>>asList(Keys.BAR__FK_BAR_FOO);
	}
