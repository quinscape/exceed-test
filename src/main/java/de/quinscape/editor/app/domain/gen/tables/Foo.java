...
public class Foo extends TableImpl<FooRecord> {
	...
	private static final long serialVersionUID = 179095487;
	 ...
	 */
	public final TableField<FooRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(150).nullable(false), this, "");
	...
	/**
	 * The column <code>public.foo.text</code>.
	 */
	public final TableField<FooRecord, String> TEXT = createField("text", org.jooq.impl.SQLDataType.VARCHAR.length(4096), this, "");
