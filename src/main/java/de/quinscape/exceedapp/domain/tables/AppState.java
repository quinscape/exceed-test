...
public class AppState extends TableImpl<AppStateRecord> {
	...
	private static final long serialVersionUID = -271713202;

	/**
	 * The reference instance of <code>shipping.app_state</code>
	 */
	...
	/**
	 * The column <code>shipping.app_state.id</code>.
	 */
	...
	/**
	 * The column <code>shipping.app_state.name</code>.
	 */
	...
	/**
	 * The column <code>shipping.app_state.path</code>.
	 */
	...
	/**
	 * The column <code>shipping.app_state.status</code>.
	 */
	...
	/**
	 * The column <code>shipping.app_state.extensions</code>.
	 */
	...
	/**
	 * Create a <code>shipping.app_state</code> table reference
	 */
	public AppState() {
		this("app_state", null);
	}
	...
	/**
	 * Create an aliased <code>shipping.app_state</code> table reference
	 */
